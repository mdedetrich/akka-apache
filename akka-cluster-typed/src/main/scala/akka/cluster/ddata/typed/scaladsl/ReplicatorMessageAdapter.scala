...
class ReplicatorMessageAdapter[A, B <: ReplicatedData]
  ...
  def askUpdate
    (
        ...
        responseAdapter: Replicator.UpdateResponse[B] => A)
    : Unit = {
    context
  ...
  def askGet
    (
        ...
        responseAdapter: Replicator.GetResponse[B] => A)
    : Unit = {
  ...
  def askDelete
    (
        ...
        responseAdapter: Replicator.DeleteResponse[B] => A)
    : Unit = {
    context
  ...
  def askReplicaCount
    (
        ...
        responseAdapter: Replicator.ReplicaCount => A)
    : Unit = {
    context
