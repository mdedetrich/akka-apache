...
abstract class AbstractPersistentFSMBase[S, D, E] extends PersistentFSMBase[S, D, E] {
  ...
  final def when
    (
        ...
        stateFunctionBuilder: FSMStateFunctionBuilder[S, D, E])
    : Unit =
